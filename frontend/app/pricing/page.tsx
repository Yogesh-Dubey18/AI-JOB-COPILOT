  ...
  return (
    <div>
      ...
      <main className="mx-auto max-w-7xl px-4 py-12">
        ...
        <p className="mt-3 max-w-3xl text-muted-foreground">Choose a job-search operating system that matches your current sprint. Payments are provider-ready and disabled until Stripe is configured.</p>
        ...
        <p className="mt-6 text-sm text-muted-foreground">No real billing is active in this demo. Configure Stripe keys and webhooks before charging users.</p>
      </main>
    </div>
  );
}
